...
def prepare_prompt(prompt_template_string: str = NUTRI_PROMPT_TEMPLATE_STRING,
    ...
    prompt_template = PromptTemplate(
        ...
        input_variables=["meal_description_string"],
...
def prompt_llm_for_response(user_input_string: str,
                            model = DEFAULT_MODEL,
    ...
    filled_prompt = prepare_prompt(meal_description_string=user_input_string,
                                   parser=parser,
